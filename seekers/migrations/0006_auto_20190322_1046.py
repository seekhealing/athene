...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(name="seekerbenefitproxy", options={"verbose_name": "Seeker benefit report"},),
        migrations.RenameField(model_name="seekerbenefittype", old_name="cost", new_name="default_cost",),
        migrations.AddField(
